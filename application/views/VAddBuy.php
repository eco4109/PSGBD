...
<head>
	...
	?>
<title >Agregar una Compra</title>
...
$(container).append('<tr> <td> <label id=tb'+iCnt+' style="margin-left: 150px;" >Elige el producto: '+iCnt+' </label><select  class="form-control" name="idArts[]"><option value="--" class="form-control">---</option><?php for ($i=0; $i < count($des_articulo); $i++) {?><option value = "<?php echo $id_articulo[$i] ;?>"> <?php echo $des_articulo[$i] ;?></option><?php } ?></select></td> <td align="center" style="padding:10px;"> <label id=tb'+iCnt+' style="margin-left: 250px;" >Cantidad: </label> <input type="number"  style="margin-left: 250px;" min=1 class="form-control" name="cantArts[]"> </td><td align="center" style="padding:10px;"> <label id=tb'+iCnt+' style="margin-left: 250px;" >PU: </label> <input type="number"  style="margin-left: 250px;" min=1 class="form-control" name="PU[]"> </td><td align="center" style="padding:10px;"> <label id=tb'+iCnt+' style="margin-left: 250px;" >Total: </label> <input type="number"  style="margin-left: 250px;" min=1 class="form-control" name="Total[]"> </td> </tr>');
...
<body  >
	<form method= "post" action="agregaProCompra">
		...
		<table align="center">
			<tr>
				...
				<td style="padding: 50px;">
					<input style="width:70px;" type="text" class="form-control" name="idVenta" value="<?php echo $idCompra ;?>" readonly>
				</td>
			</tr>
